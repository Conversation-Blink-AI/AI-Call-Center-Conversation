...
type HelpCenterContentProps = {
  /** Public pages hide dashboard-only links and show FAQ/support instead. */
  isPublic?: boolean
}

export function HelpCenterContent({ isPublic = false }: HelpCenterContentProps) {
  return (
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <p className="text-muted-foreground mb-3">
              To make and receive calls, you need a phone number. You can purchase one directly from
              the platform.
            </p>
            <ul className="list-disc list-inside space-y-1 text-muted-foreground ml-4">
              <li>
                Navigate to <strong>Phone Numbers</strong> in the sidebar
              </li>
              <li>
                Click <strong>Purchase Number</strong>
              </li>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-1 text-muted-foreground ml-4">
              <li>
                Go to <strong>My Pathway</strong> to see your flows and phone numbers
              </li>
      ...
      <div className="mb-8">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <Card className="border-border">
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Purchase and manage phone numbers directly in the platform. Assign different call
                flows to different numbers, or use the same flow across multiple numbers. View and
          ...
          <Card className="border-border">
            ...
            <CardContent>
              <p className="text-muted-foreground">
                ...
                using them, and choose the perfect voice that matches your brand and use case. Each
                voice has unique characteristics and ratings.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-border">
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Track your call performance with detailed analytics. View call history, success
                rates, conversion metrics, and more. Use the data to optimize your call flows and
                improve results.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-border">
            ...
            <CardContent>
              <p className="text-muted-foreground">
                ...
                listen to recordings. Use this information to understand how your flows are
        ...
        <CardContent className="space-y-6">
          <div>
            ...
            <ol className="list-decimal list-inside space-y-1 text-muted-foreground ml-4">
              <li>
                Go to <strong>Send Call</strong> in the sidebar
              </li>
              ...
              <li>
                Click <strong>Send Call</strong> to initiate the call
              </li>
            </ol>
          </div>
          ...
          <div>
            ...
            <ol className="list-decimal list-inside space-y-1 text-muted-foreground ml-4">
              <li>
                Navigate to <strong>My Pathway</strong> or <strong>Call Flows</strong>
              </li>
          ...
          <div>
            ...
            <ol className="list-decimal list-inside space-y-1 text-muted-foreground ml-4">
              <li>
                Go to <strong>Analytics</strong> in the sidebar
              </li>
              <li>
                View your dashboard with key metrics like total calls, success rate, and active flows
              </li>
          ...
          <div>
            ...
            <ol className="list-decimal list-inside space-y-1 text-muted-foreground ml-4">
              ...
              <li>
                Click <strong>Add Funds</strong> or <strong>Top Up</strong>
              </li>
          ...
          <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
            {isPublic ? (
              <>
                ...
                <li>
                  Review{" "}
                  <Link href="/public-api" className="text-primary hover:underline">
                    API docs
                  </Link>{" "}
                  for integrations
                </li>
                <li>
                  Email{" "}
                  <a href="mailto:support@hustleapp.co" className="text-primary hover:underline">
                    support@hustleapp.co
                  </a>
                </li>
                <li>
                  ...
                  to access your dashboard and account settings
                </li>
              </>
            ) : (
              <>
                <li>
                  ...
                  for an overview of your account
                </li>
                <li>
                  Visit{" "}

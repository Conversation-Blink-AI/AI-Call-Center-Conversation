    ...
    >
      <div className="overflow-hidden h-full flex items-center">
        <div className="flex items-center space-x-1.5">
          <HelpCircle className="w-5 h-5 text-blue-600 dark:text-blue-300 flex-shrink-0" />
          <div>
            <div className="text-[14px] font-medium text-blue-800 dark:text-blue-100">{data.name || 'Question'}</div>
            <div
